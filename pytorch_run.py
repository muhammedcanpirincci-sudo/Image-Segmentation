...
t_data = '/content/splitted/train/imgs/'
l_data = '/content/splitted/train/img_GT/'
test_image = '/content/splitted/test/imgs/00087a6bd4dc_04.jpg'
test_label = '/content/splitted/test/img_GT/00087a6bd4dc_04_mask.gif'

test_folderP = '/content/splitted/test/imgs/*'
test_folderL = '/content/splitted/test/img_GT/*'
...
#    pred = threshold_predictions_p(pred) #Value kept 0.01 as max is 1 and noise is very small.
    ...
    x1 = plt.imsave('./model/gen_images/im_epoch_' + str(epoch) + 'int_' + str(i)
                    + '_img_no_' + str(img_test_no) + '.jpg', pred[0][0])
